...
class PlayerModelAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return qs.annotate(points=Coalesce(Sum('points_set__value'), 0)).order_by('-points')
...
class PointModelAdmin(admin.ModelAdmin):
    search_fields = ('code', 'value', 'acquired_by_player__username', 'type_of_points__name', 'description')
    list_filter = ('value',)
    list_display = ('code', 'value', 'acquired_by_player', 'type_of_points', 'description')
